...
var _accumulate = __webpack_require__(2);
...
var isLBRACK = function isLBRACK(c) {
    return c === '[';
};
var isRBRACK = function isRBRACK(c) {
    return c === ']';
};
            ...
            switch (_context.prev = _context.next) {
                ...
                case 4:
                    ...
                    isRecognized = actions.some(function (_ref) {
                        ...
                        token = new _token2.default(type, text);
                        return true;
                    });
...
var _lexer = __webpack_require__(0);
...
[].concat(_toConsumableArray(tokens)).forEach(function (token) {
...
var accumulate = function accumulate(cursor, filter) {
    var segment = cursor.source.slice(cursor.position);

    var cache = [];
    segment.split('').every(function (c) {
        if (!filter(c)) {
            return false;
        }
...
module.exports = __webpack_require__(36) || !__webpack_require__(7)(function () {
  var K = Math.random();
...
__webpack_require__(16)(IteratorPrototype, __webpack_require__(9)('iterator'), function () {
  return this;
});
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(16)(proto, TO_PRIMITIVE, __webpack_require__(122));
...
$export($export.S + $export.F * !__webpack_require__(10), 'Object', { defineProperties: __webpack_require__(103) });
...
__webpack_require__(10) && $export($export.P + __webpack_require__(59), 'Object', {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(117), __webpack_require__(301)(module)))
