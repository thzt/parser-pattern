...
var _accumulate = __webpack_require__(300);
...
var _filterIterator = __webpack_require__(301);
...
var parser = function parser(tokens) {
    var filteredTokens = (0, _filterIterator2.default)(tokens, function (token) {
        return token.type !== 'WS';
    });

    var _filteredTokens$next = filteredTokens.next(),
...
var _lexer = __webpack_require__(114);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(113), __webpack_require__(303)(module)))
...
var filterIterator = regeneratorRuntime.mark(function filterIterator(iter, filter) {
    var _iter$next, done, value;

    return regeneratorRuntime.wrap(function filterIterator$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                case 0:
                    if (false) {
